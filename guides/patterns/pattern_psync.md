...
// In get_auth_header:
fn get_auth_header(&self, auth_type: &ConnectorSpecificConfig) -> CustomResult<Vec<(String, Maskable<String>)>, ConnectorError> {
...
```rust
fn get_auth_header(&self, _auth_type: &ConnectorSpecificConfig) -> CustomResult<Vec<(String, Maskable<String>)>, ConnectorError> {
