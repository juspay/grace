...
<output_file>
Store the implementation plan in grace/connector_integration/{{connector_name}}/{{connector_name}}_plan.md
</output_file>
...
- `grace/connector_integration/{{connector_name}}/{{connector_name}}_specs.md`
...
- `add [payment_method] to {{connector_name}} using grace/integrate_connector.md`
- `add [flow] flow to {{connector_name}} using grace/integrate_connector.md`
