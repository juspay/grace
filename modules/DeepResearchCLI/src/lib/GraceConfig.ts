...
/**
 * Configuration interface for GraceResearcher
 */
...
/**
 * Comprehensive configuration options for Grace researcher
 */
export interface GraceConfigDetailed extends GraceConfig {
