...
/**
 * Main class for programmatic access to MASS research capabilities
 *
 * @example
 * ```typescript
 ...
 * ```
 */
export class MassResearcher extends EventEmitter {
  ...
  /**
   * Create a new MassResearcher instance
   * @param config Configuration for the researcher
   */
  constructor(config: MassConfig) {
    super();
